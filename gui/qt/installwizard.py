...
MSG_GENERATING_WAIT = _("Wampum is generating your addresses, please wait...")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Wampum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon(':icons/wampum.png')
        self.show()
        self.raise_()
    ...
    def run_and_get_wallet(self):
        ...
        self.set_layout(vbox, title=_('Wampum wallet'))
        ...
        if self.storage.requires_split():
            self.hide()
            msg = _("The wallet '%s' contains multiple accounts, which are no longer supported since Wampum 2.7.\n\n"
    ...
    def set_icon(self, filename):
        #filename: :icons/wampum.png
        prior_filename, self.icon_filename = self.icon_filename, filename
        #TODO:fix this error 60 to 120 to 0
        #myPixmap = QPixmap(filename)
        #self.logo.pixmap().scaledToWidth(QSize(self.logo.size()), Qt.KeepAspectRatio, Qt.FastTransformation)
        #myScaledPixmap = myPixmap.scaled(self.size(), Qt.KeepAspectRatio)
        #print("myPixmap:",myPixmap)
        #self.logo.setPixmap(QPixmap(filename).scaledToWidth(120))
        #self.logo.setPixmap(QPixmap(filename).scaled(QSize(self.logo.size()),Qt.KeepAspectRatio,Qt.FastTransformation ))
        #self.logo.setPixmap(myScaledPixmap)

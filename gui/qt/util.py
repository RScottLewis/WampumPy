...
from wampum.paymentrequest import PR_UNPAID, PR_PAID, PR_EXPIRED
...
class WampumItemDelegate(QStyledItemDelegate):
...
class MyTreeWidget(QTreeWidget):
    ...
    def __init__(self, parent, create_menu, headers, stretch_column=None,
        ...
        self.setItemDelegate(WampumItemDelegate(self))
